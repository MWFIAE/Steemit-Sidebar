...
unsafeWindow.MWSidebar ={
    ...
    updateDisplay :function(target, user) {
        ...
        content = content
            ...
            .replace(/{bw_c}/g, MWSidebar.helper.prettyPrintBytes(user.bw_m-user.bw_a))
            .replace(/{bw_m}/g, MWSidebar.helper.prettyPrintBytes(user.bw_m))
            .replace(/{bw_p}/g, user.bw_p.toFixed(2))
            .replace(/{vote_time}/g, user.voteTime)
            .replace(/{vote_span}/g, user.voteSpan)
            .replace(/{vote_color}/g, MWSidebar.helper.lerpColor(MWSidebar.settings.barColorHigh, MWSidebar.settings.barColorLow, (100-user.trueVotePower)/100))
            .replace(/{bw_color}/g, MWSidebar.helper.lerpColor(MWSidebar.settings.barColorHigh, MWSidebar.settings.barColorLow, (100-user.bw_p)/100))
